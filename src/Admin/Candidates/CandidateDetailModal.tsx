...
import { X, Mail, Phone, Calendar, FileText, Download, User } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-gray-600 mt-1">Thông tin chi tiết và lịch sử ứng tuyển</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{candidate.total_applications}</div>
                <div className="text-sm text-gray-600">Đơn ứng tuyển</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">{candidate.job_titles.length}</div>
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Lần cuối ứng tuyển</div>
              </div>
            </div>
          </div>
          ...
          {/* Applied Positions */}
          <div className="mb-6">
            <h4 className="text-lg font-semibold text-gray-900 mb-4">Vị trí đã ứng tuyển</h4>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="flex items-center text-sm text-gray-600 mt-1">
                        ...
                        Ứng tuyển ngày {new Date(candidate.latest_application_date).toLocaleDateString("vi-VN")}
                      </div>
                    </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">{candidate.cv_filename}</div>
          ...
          {/* Additional Info */}
          {(candidate.skills || candidate.experience_level || candidate.location) && (
            <div className="mb-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Thông tin bổ sung</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {candidate.experience_level && (
                  <div>
                    <div className="text-sm font-medium text-gray-700">Kinh nghiệm</div>
                    <div className="text-gray-900">{candidate.experience_level}</div>
                  </div>
                )}
                {candidate.location && (
                  <div>
                    <div className="text-sm font-medium text-gray-700">Địa điểm</div>
                    <div className="text-gray-900">{candidate.location}</div>
                  </div>
                )}
                {candidate.skills && (
                  <div>
                    <div className="text-sm font-medium text-gray-700">Kỹ năng</div>
